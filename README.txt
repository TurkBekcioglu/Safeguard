...
NOTE: In order to play the demo version, unzip the Safeguard(win)_Data.zip and place it's contents within the same folder as Safeguard(win).exe, then simply run the exe file.
